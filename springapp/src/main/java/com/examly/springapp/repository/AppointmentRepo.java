...
public interface AppointmentRepo extends JpaRepository<Appointment, Long> {
    ...
    // It finds appointments by matching the 'userId' field inside the 'user' object.
    List<Appointment> findByUserUserId(Long userId);
    // --- All other custom queries from before are still needed ---
...
void deleteByServiceId(@Param("serviceId") Long serviceId);
    ...
    List<String> findBookedTimeSlotsByServiceIdAndDate(@Param("serviceId") Long serviceId, @Param("date") LocalDate date);
    ...
    boolean existsByUserAndServiceAndDate(@Param("userId") Long userId, @Param("serviceId") Long serviceId, @Param("date") LocalDate date);
    ...
    boolean existsByServiceIdAndDateAndTimeSlot(@Param("serviceId") Long serviceId, @Param("date") LocalDate date, @Param("timeSlot") String timeSlot);
    ...
    Optional<Appointment> findClashingAppointment(@Param("serviceId") Long serviceId, @Param("date") LocalDate date, @Param("timeSlot") String timeSlot, @Param("excludeAppointmentId") Long excludeAppointmentId);
}